            ...
            <?foreach ($articles as $article):?>
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry justify-content-end">
                        <a href="/article/single/id/<?=$article->getId()?>" class="block-20" style="background-image: url('<?=sprintf('/%s/%s', ArticleModel::IMAGE_FOLDER, $article->getImage())?>');">
                        </a>
                        <div class="text p-4 float-right d-block">
                            ...
                            <h3 class="heading mb-3"><a href="/article/single/id/<?=$article->getId()?>"><?=$article->getTitle()?></a></h3>
                            <p><?=$article->getContent()?></p>
                            <p><a href="/article/single/id/<?=$article->getId()?>" class="btn-custom"><span class="ion-ios-arrow-round-forward mr-3"></span>Read more</a></p>
                        </div>
                    </div>
                </div>
<!--                var_dump($article);-->
